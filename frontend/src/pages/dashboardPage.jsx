...
const DashboardPage = () => {
    ...
    return (
        <div>
            ...
            <div>
                {/* Logout button */}
                <div className='absolute ml-[8.5%] mt-[4%]'>
                    ...
                    <span className="text-[1.15vw] font-poppins font-normal text-white">Logout</span>
                    </Link>
                </div>
                ...
                <div>
                    ...
                    <div className="flex justify-center pt-8">
                        <svg width="8%" height="auto" viewBox="0 0 155 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='mt-[2vh] flex space-x-5 '>
                        ...
                        <div className='relative h-[21vh] w-[34vw] bg-white rounded p-[3.5vh]'>
                            ...
                            <div className='relative flex flex-row items-end'>
                                <h1 className='font-poppins font-semibold text-[2.75vh] text-black'>AKCSE Executive Meeting</h1>
                ...
                >
                    ...
                    <span className="text-[1.65vw] font-poppins font-semibold text-[#B3B3B3]">Create New Meeting</span>
                </div>
            </div>
            ...
            {/* blue bg */}
            <div className='absolute top-0 left-0 w-full h-screen bg-steel_blue overflow-hidden z-[-2]'></div>
