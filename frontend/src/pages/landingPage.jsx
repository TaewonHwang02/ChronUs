...
const LandingPage = () => {
  return (
    <div className="relative w-full h-screen flex items-center overflow-hidden">
      ...
      {/* rectangle row 1*/}
      <div className='invisible ph:visible tb:visible'>
        {/* gradient rectangle */}
      ...
      <div className='invisible ph:visible tb:visible'>
        {/* Clear rectangle */}
        <div class="absolute top-0 right-[-60%] tb:right-[7%] w-64 h-20 bg-white opacity-40 flex items-center justify-center"> </div>
        <div class="absolute top-[15%] right-[-60%] tb:right-[7%] w-64 h-64 bg-white flex items-center justify-center"> </div>
        <div class="absolute bottom-0 right-[-60%] tb:right-[7%] w-64 h-64 bg-white flex items-center justify-center"> </div>
      </div>
      
      {/* Left Side */}
      <div className='flex flex-col space-y-[30px] translate-y-[-30px] ml-[45px] ph:ml-[20%] tb:ml-[5%]'>
        {/*logo */}
        <div className="">
        ...
        <div className="text-white">
          <h2 className="text-3xl tb:text-5xl font-poppins mb-2">Plan Smarter</h2>
          <h2 className="text-3xl tb:text-5xl font-poppins mb-2">with</h2>
          <h1 className="text-5xl tb:text-8xl font-kulim">
            <span className="text-white font-normal">Chron</span>
            <span className="text-selective_yellow text-6xl tb:text-9xl">u</span>
      ...
      <div className="absolute bottom-0 text-left font-poppins m-[10px]"> 
        <p className="text-sm text-black tb:text-white">
            Not registered yet?{' '}
            <a href="#" className="">
              Register Now
            </a>
